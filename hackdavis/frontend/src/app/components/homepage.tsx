            ...
            <main>
                ...
                <div className="flex w-full">
                    ...
                    <p className="py-3">Quickly check any product for allergens or dietary restrictions.</p>
                        <div className="flex flex-row space-x-4"> {/* Added flex container */}
                         <button className="text-yellow-400 bg-sky-950 rounded-xl border font-semibold px-6 py-1 transition duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1" onClick={() => isLoggedIn("/scan")}>
                          Scan an Item
                         </button>
                        <button className="text-yellow-400 bg-sky-950 rounded-xl border font-semibold px-6 py-1 transition duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1" onClick={() => isLoggedIn("/search")}>
                           Search Database
                        </button>
                        </div>
                    </div>
                ...
                <section className="relative pb-20">
                    ...
                    <div className="flex justify-between px-10 pt-24 pb-20">
                        <div onClick={() => isLoggedIn("/update")} className="border flex flex-col items-center transition duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1 rounded-3xl cursor-pointer">
                        ...
                        <div onClick={() => isLoggedIn("/scan")} className="border flex flex-col items-center transition duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1 rounded-3xl cursor-pointer">
                            <div className="flex flex-col justify-end h-[160px]">
                        ...
                        <div onClick={() => isLoggedIn("/search")} className="border flex flex-col items-center transition duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1 rounded-3xl cursor-pointer">
                            <div className="flex flex-col justify-end h-[160px]">
                        ...
                        <div onClick={() => isLoggedIn("/pastScans")} className="border flex flex-col items-center transition duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1 rounded-3xl cursor-pointer">
                            <div className="flex flex-col justify-end h-[160px]">
